...
public:
	...
	*******************************************************************************/
	...
	static void SetCurrentImageIndex(MonoString* _entityName, MonoString* _sceneName, int _index);
	static int GetCurrentImageIndex(MonoString* _entityName, MonoString* _sceneName);
