...
//*******************************************************************************/
//std::vector<float> Renderer::GetImGuizmoMat4(const Entity& _e)
//{
...
//*******************************************************************************/
//void Renderer::BindTextureUnit(const GLuint& _texID, TextureInfo& _texInfo, std::vector<int>& _texUnits)
//{
...
//*******************************************************************************/
//void Renderer::BatchRenderArrays(GLenum _mode, const std::vector<Vertex>& _vertices)
//{
...
//*******************************************************************************/
//void Renderer::BatchRenderElements(GLenum _mode, const std::vector<Vertex>& _vertices, const std::vector<GLushort>& _indices)
//{
//	if (_vertices.empty()) return;
//	glNamedBufferSubData(mAllocator.mvboid, 0, sizeof(Vertex) * _vertices.size(), _vertices.data());
...
//Current texture units that are in use.
//*******************************************************************************/
//void Renderer::BatchRenderTextures(int& _texCount, std::vector<int>& _texUnits)
//{
//	_texCount = 0;
...
//*******************************************************************************/
//void Renderer::CreateSquare(const Entity& _e, std::vector<Vertex>& _vertices, std::vector<GLushort>& _indices)
//{
...
//The entity containing Transform and Sprite component.
//*******************************************************************************/
//void Renderer::CreateCircle(const Entity& _e)
//{
//	Math::Mat3 mtx = GetTransform(_e);
//	glm::vec4 clr = GetColor(_e);
...
//The entity containing Transform and Sprite component.
//*******************************************************************************/
//void Renderer::CreateDebugPoint(const Entity& _e)
//{
...
//The color component.
//*******************************************************************************/
//void Renderer::CreateDebugPoint(const Transform& _t, const Color& _c)
//{
...
//The entity containing Transform and Sprite component.
//*******************************************************************************/
//void Renderer::CreateDebugLine(const Entity& _e)
//{
...
//The color component.
//*******************************************************************************/
//void Renderer::CreateDebugLine(const Transform& _t, const Color& _c)
//{
//	glm::vec4 clr = GetColor(_c.r, _c.g, _c.b, _c.a);
...
//The entity containing Transform and Sprite component.
//*******************************************************************************/
//void Renderer::CreateDebugSquare(const Entity& _e)
//{
...
//The color component.
//*******************************************************************************/
//void Renderer::CreateDebugSquare(const Transform& _t, const Color& _c)
//{
//	Math::Mat3 mtx = GetTransform(_t.scale, _t.rotation, _t.translation);
//	glm::vec4 clr = GetColor(_c.r, _c.g, _c.b, _c.a);
//	Vertex v0, v1, v2, v3;
...
//The entity containing Transform and Sprite component.
//*******************************************************************************/
//void Renderer::CreateDebugCircle(const Entity& _e)
//{
...
//The color component.
//*******************************************************************************/
//void Renderer::CreateDebugCircle(const Transform& _t, const Color& _c)
//{
//	Math::Mat3 mtx = GetTransform(_t.scale, _t.rotation, _t.translation);
//	glm::vec4 clr = GetColor(_c.r, _c.g, _c.b, _c.a);
//
...
//The entity containing Transform and Sprite component.
//*******************************************************************************/
//void Renderer::CreateDebugArrow(const Entity& _e)
//{
//	CreateDebugLine(_e);
...
//The color component.
//*******************************************************************************/
//void Renderer::CreateDebugArrow(const Transform& _t, const Color& _c)
//{
...
//*******************************************************************************/
//void Renderer::SetDebug(bool _set)
//{
//	mDebug = _set;
//}
//
...
//*******************************************************************************/
//void Renderer::SetVectorLengthModifier(float _modifier)
//{
...
//*******************************************************************************/
//glm::vec4 Renderer::GetColor(const Entity& _e)
//{
...
//Returns the color.
//*******************************************************************************/
//glm::vec4 Renderer::GetColor(GLubyte _r, GLubyte _g, GLubyte _b, GLubyte _a)
//{
...
//*******************************************************************************/
//Math::Mat3 Renderer::GetTransform(const Entity& _e)
//{
...
//The Transformation matrix.
//*******************************************************************************/
//Math::Mat3 Renderer::GetTransform(const Math::Vec2& _scale, float _rotate, const Math::Vec2& _translate)
//{
...
//	};
//
//	temp[2][0] -= mCam.GetPos().x;
//	temp[2][1] -= mCam.GetPos().y;
//
//	temp[0][0] /= (float)*mWindowWidth * mCam.GetZoom();
//	temp[0][1] /= (float)*mWindowHeight * mCam.GetZoom();
//	temp[1][0] /= (float)*mWindowWidth * mCam.GetZoom();
//	temp[1][1] /= (float)*mWindowHeight * mCam.GetZoom();
//	temp[2][0] /= (float)*mWindowWidth / 2.f * mCam.GetZoom();
//	temp[2][1] /= (float)*mWindowHeight / 2.f * mCam.GetZoom();
//
//	return temp;
//}
//
...
//*******************************************************************************/
//void Renderer::ConcatIndices(std::vector<GLushort>& _first, std::vector<GLushort>& _second)
//{
//	if (_first.empty())
//	{
