/*!*****************************************************************************
\file Level3Passenger1Script.cs
\author Lee Hsien Wei Joachim
\par DP email: l.hsienweijoachim@digipen.edu
\par Group: Memory Leak Studios
\date 10-03-2023
\brief
Level3Passenger1Script contains the logic that handles the logic of the animation
...
namespace BonVoyage {
  ...
  public class Level3LittleGirlScript : PassengerBaseScript {
    ...
    public override void Init(int _ENTITY) {
      ...
      triggerBox = VI.Entity.GetId(Level3DialogManager.LittleGirlBoxString);

      firstPassengerID = VI.Entity.GetId(Level3DialogManager.P1String);
      firstPassengerBox = VI.Entity.GetId(Level3DialogManager.P1BoxString);
    }
