/*!*****************************************************************************
\file Level3Passenger2Script.cs
\author Lee Hsien Wei Joachim
\par DP email: l.hsienweijoachim@digipen.edu
\par Group: Memory Leak Studios
\date 10-03-2023
\brief
Level3Passenger2Script contains the logic that handles the logic of the animation
...
namespace BonVoyage {
  ...
  public class Level3Passenger2Script : PassengerBaseScript {
    ...
    public override void Init(int _ENTITY) {
      ...
      triggerBox = VI.Entity.GetId(Level3DialogManager.P2BoxString);

      correctDestination_Box = VI.Entity.GetId(Level3DialogManager.P2CorrectBoxString);
      correctDestination_RenderLocation = VI.Entity.GetId(Level3DialogManager.P2CorrectRenderString);

      wrongDestination_Box = VI.Entity.GetId(Level3DialogManager.P2WrongBoxString);
      wrongDestination_RenderLocation = VI.Entity.GetId(Level3DialogManager.P2WrongRenderString);
    }
    ...
    public override void Update(int _ENTITY) {
      ...
      if (ReadyToAttach && !Level3DialogManager.runPassenger2Dialog) {
        // Set flag variables
        fadingOut = true;
      ...
      if (VI.Physics.IsCollided(correctDestination_Box, _ENTITY)) {
        ...
        PlayerScript.PlayerInOtherAnimation = true;
        Level3DialogManager.passengerDialogProgress = 21;
        ...
        DetachFromPlayerAnimation = true;
        PlayerScript.PlayerInOtherAnimation = true;
        Level3DialogManager.passengerDialogProgress = 20;
